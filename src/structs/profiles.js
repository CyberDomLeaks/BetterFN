                ...
                items: {                    
                    "CosmeticLocker:cosmeticlocker_athena1": {
                        ...
                        attributes: {
                            locker_slots_data: {
                                slots:  {
                                    Glider: {
                                        ...
                                        activeVariants: [
                                            athena.glidervariants.length != 0 ? 
                                            {
                                                variants: athena.glidervariants
                                            } : null
                                        ]
                                    },
                                    Dance: {
                            ...
                            use_count: 0,
                            banner_icon_template: "InfluencerBanner38",
                            banner_color_template: "DefaultColor22",
                            locker_name: "BetterFN",
                            item_seen: false,
                            favorite: false
                        },
                        "quantity": 1
